...
class CacheConfig:
    ...
    DOCUMENT_PROCESS_CACHE_TTL: int = int(os.getenv("DOCUMENT_PROCESS_CACHE_TTL", "7200"))  # 2 hours
    ...
    ENABLE_DOCUMENT_PROCESSING_CACHE: bool = os.getenv("ENABLE_DOCUMENT_PROCESSING_CACHE", "true").lower() == "true"
